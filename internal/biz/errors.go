...
var (
	ErrUserNameAlreadyExists = errors.New("the user already exists, please try a different email")
	ErrEmailAlreadyExists    = errors.New("the email already exists, please try a different email")
